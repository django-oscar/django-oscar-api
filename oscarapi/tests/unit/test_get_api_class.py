...
class ApiOverrideTest(APITest):
    ...
    def test_login_serializer_can_be_extended(self):
        ...
        self.assertNotIn("my_extension", login_data,
            "The serializer should not have any extension")
        ...
        with self.settings(OSCARAPI_OVERRIDE_MODULES=["oscarapi.tests"]):
            ...
            self.assertIn("my_extension", login_data,
                "The serialzier should have an extension")

        self.assertNotEqual(login_serializer, my_login_serializer,
