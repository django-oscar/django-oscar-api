...
urlpatterns = patterns('',
    ...
    url(r'^basket/add-product/$', 'commerceconnect.views.add_product', name='api-basket-add-product'),
    url(r'^basket/add-voucher/$', 'commerceconnect.views.add_voucher', name='api-basket-add-voucher'),
