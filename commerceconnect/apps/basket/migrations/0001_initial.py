...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'basket_line', (
            ...
            ('stockrecord', self.gf('django.db.models.fields.related.ForeignKey')(related_name='basket_lines', to=orm['partner.StockRecord'])),
    ...
    models = {
        ...
        'basket.line': {
            ...
            'stockrecord': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'basket_lines'", 'to': "orm['partner.StockRecord']"})
        },
