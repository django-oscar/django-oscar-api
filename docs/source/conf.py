...
html_theme_options = dict(
    project_name = "Django Oscar API",
    logo = "images/logo.png",
    logo_alt = "Django Oscar API",
    github_url = "https://github.com/django-oscar/django-oscar-api/blob/master/docs/",
    logo_height = 59,
    logo_url = "/",
    logo_width = 45,
    footer_links = ""
